...
const TRACKS = [
  {
    ...
    avoids:
      "SA property, excessive cash in local accounts, over-concentration in ZAR assets.",
    highlights: [
      "Offshore ETFs & USD exposure",
      "TFSA R46k annual limit",
      "RA tax deductions",
  ...
  },
  {
    ...
    avoids:
      "Luxury vehicle finance, lifestyle inflation, new debt that affects affordability.",
    highlights: [
      "R300k–R400k deposit target",
      "Bond pre-approval",
      "Transfer duty planning",
  ...
  },
  {
    ...
    avoids:
      "Aggressive risk-taking, neglecting debt for speculative investments, lifestyle inflation.",
    highlights: [
      "Debt elimination first",
      "6-month emergency fund",
      "TFSA entry investing",
      "Bond vs RA prioritisation",
    ],
    color: "var(--sage)",
      ...
      <div className="container">
        <div className="tracks-header">
          ...
          <p className="tracks-subtitle">
            Your first five years matter. Each Vision Track is a curated roadmap
            designed around a specific life goal. Choose the one that excites
            you most! OR browse all three to understand the trade-offs.
          </p>
        </div>
              ...
              <div className="track-body">
                ...
                <div className="track-highlights">
                  {track.highlights.map((h) => (
                    <span key={h} className="track-highlight-pill">
                      {h}
                    </span>
                  ))}
                </div>
            ...
            <table className="compare-table">
              ...
              <tbody>
                {[
                  ...
                  [
                    "Year 1 Focus",
                    "Open TFSA + offshore account",
                    "Emergency fund + clear debt",
                  ...
                  [
                    "Best Outcome (5yr)",
                    "R500k+ offshore portfolio",
                    "Own first property",
                    "Debt-free + R100k invested",
                  ],
                ].map(([cat, ...vals]) => (
                  <tr key={cat}>
