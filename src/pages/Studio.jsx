...
const STUDIOS = [
  {
    ...
    icon: <img src="../used-luxury.jpg" alt="Used vs Luxury Car" />,
    title: "Luxury Car vs Used Car",
    subtitle:
      "Finance a R600k luxury car or buy used and invest the difference?",
    description:
      "One of the most common wealth-destroying decisions young professionals make. This studio compares the true total cost of ownership including: finance, insurance, fuel, depreciation, and shows what the monthly saving could become if invested.",
  ...
  },
  {
    ...
    icon: <img src="../rent-buy.png" alt="Rent vs Buy" />,
    title: "Rent vs Buy in South Africa",
    subtitle:
      "Is owning a home actually better than renting in Johannesburg or Cape Town?",
    description:
      "Running the real numbers: bond repayments, transfer duty, rates & levies, versus rental costs and investing the deposit. The answer might surprise you.",
  ...
  },
  {
    ...
    icon: (
      <img src="../local-offshore.png" alt="Local vs Offshore Allocation" />
    ),
    title: "Local vs Offshore Allocation",
    subtitle:
      "How much of your portfolio should be offshore? Model the Rand impact.",
    description:
      "Simulate different local vs offshore portfolio splits and see how historical Rand depreciation affects real returns. Find your optimal allocation.",
      ...
      <div className="container">
        <div className="studio-page-header">
          ...
          <p className="studio-page-subtitle">
            Big financial decisions deserve a rehearsal. Each studio lets you
            adjust the real variables of a decision the prices, rates, time
            horizons and helps you see the impact before you commit. The numbers
            are simplified but the logic is real.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Pick the financial decision you want to explore.",
              },
              {
                step: "2",
                label: "Adjust the inputs",
                desc: "Move sliders to match your real situation: price, income, rates, term.",
              },
              {
                step: "3",
                label: "Read the verdict",
                desc: "Get a plain-language summary of the trade-offs and long-term impact.",
              },
              {
                step: "4",
                label: "Apply to your Vision",
                desc: "See how the decision affects your Vision Track progress.",
              },
            ].map((s) => (
        ...
        <div className="studios-list">
          {STUDIOS.map((studio) => (
            <div
              key={studio.id}
              className={`studio-card card ${!studio.available ? "studio-card-disabled" : ""}`}
            >
              <div
                className="studio-card-visual"
                style={{ background: studio.bg }}
              >
                <span
                  className="studio-card-emoji"
              ...
              <div className="studio-card-body">
                ...
                <p
                  className="studio-card-subtitle"
                  style={{ color: studio.color }}
                >
                  {studio.subtitle}
                </p>
        ...
        <div className="studio-disclaimer">
          <p>
            <strong>Note:</strong> Studio calculations are simplified models
            designed to illustrate trade-offs and relative comparisons. They are
            not financial advice. For personalised advice, speak to a registered
            South African financial advisor (CFP). Numbers use approximate SA
            market rates as at 2024/25.
          </p>
        </div>
      </div>
    </div>
