    ...
    <div className="home">
        ...
        <div className="container">
          <div className="hero-inner">
            <div className="hero-content">
              <span className="hero-eyebrow hand-note">
                Your first five years start now ✦
              </span>
              ...
              <p className="hero-subtitle">
                ABSA NextGen Wealth Studio turns financial planning into a
                vision board. See exactly where your money is going, choose a
                path that fits your dreams, and simulate the big decisions
      ...
      <section className="section value-props">
        <div className="container">
          <div className="section-header" style={{ textAlign: "center" }}>
            ...
            <h2>
              Your bank finally works <em>for</em> your vision
            </h2>
            <p>
              Most banking apps tell you where your money went. We show you
          ...
          <div className="vp-grid">
            {[
              ...
              <div key={vp.title} className="vp-card card-pinned">
                <div className="vp-icon" style={{ color: vp.color }}>
                  {vp.icon}
                </div>
                <h4>{vp.title}</h4>
                <p>{vp.desc}</p>
        ...
        <div className="container">
          <div className="who-inner">
            <div className="who-text">
              ...
              <p>
                You earn well which is R30,000 to R80,000 a month. But your
                money feels like it disappears. You're caught between lifestyle
                (the car, the apartment, the travel) and long-term goals you
                know matter.
              </p>
              <p style={{ marginTop: "1rem" }}>
                NextGen Wealth Studio gives you the roadmap your salary
                deserves. SARS-aware, South African, and built around what{" "}
                <em>you</em> actually want.
              </p>
              ...
              {[
                {
                  ...
                  quote:
                    '"I want to stop renting and own a townhouse in Parkhurst within 3 years."',
                },
                {
                  name: "Lebo, 27",
                  ...
                  quote:
                    '"I want to build offshore wealth and create location-independent income."',
                },
                {
                  name: "Priya, 32",
                  ...
                  quote:
                    '"I need to pay off debt, build security, and still enjoy the life I worked for."',
                },
              ].map((p) => (
          ...
          <div className="card-feature sa-feature-card">
            <div className="sa-feature-inner">
              <div>
                ...
                >
                  Built around SARS tax brackets, South African prime lending
                  rates, TFSA annual limits (R46,000), RA contribution rules
                  (27.5% of taxable income), and offshore allowance limits. No
                  generic calculators. This is designed for you.
                </p>
              </div>
      ...
      <section className="section home-cta">
        <div className="container" style={{ textAlign: "center" }}>
          <span className="hand-note" style={{ fontSize: "2rem" }}>
